...
# if Sala in admin.site._registry:
#     admin.site.unregister(Sala)
# if Agendamento in admin.site._registry:
#     admin.site.unregister(Agendamento)
...
#             return format_html(
#                 '<span style="background: linear-gradient(45deg, #FFD700, #FFA500); color: white; padding: 4px 8px; border-radius: 12px; font-weight: bold;">⭐ ESPECIAL</span>'
#             )
#         else:
#             return format_html(
...
#     class Media:
#         css = {
#             'all': ('admin/css/admin_colors.css',)
#         }
